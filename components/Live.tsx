...
import { useBroadcastEvent, useEventListener, useMyPresence, useOthers, useUpdateMyPresence } from "@/liveblocks.config";
...
const Live = () => {
    ...
    return (
        ...
        >
            ...
            {reaction.map((r) => (
                <FlyingReaction key={r.timestamp.toString()} x={r.point.x} y={r.point.y} value={r.value} timestamp={r.timestamp} />
            ))}
            {cursor && (<CursorChat
                cursor={cursor}
